...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userWithEmailExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                strongSelf.alertUserLoginError(message: "An account with that email exists")
                return
            }
    ...
    func alertUserLoginError(message: String = "Please enter all info to crate an account") {
